/**
  \file G3D-app.lib/source/PhysXPhysics.cpp
...
void PhysXPhysics::insertEntity(const G3D::Entity *entity) {
...
void PhysXPhysics::removeEntity(const G3D::Entity *entity) {
...
void PhysXPhysics::applyForceField(const G3D::Entity *field,
...
const G3D::Constraint *const
PhysXPhysics::addConstraint(const G3D::Entity *entityA,
...
void PhysXPhysics::removeConstraint(const G3D::Constraint *const constraint) {
...
PhysXPhysics::getPrimaryCollider(const G3D::Entity *field) {
    /*auto iter = m_dynamicBodyMap.left.find(field);
    debugAssertM(iter != m_dynamicBodyMap.left.end(),
                 "Queried entity is not present in the map");
    auto fieldObject = iter->get_right();
...
void PhysXPhysics::ignoreCollisionCheck(const G3D::Entity *trigger,
...
G3D::CoordinateFrame PhysXPhysics::getFrame(const G3D::Entity *entity) {
    /*auto iter = m_dynamicBodyMap.left.find(entity);
    debugAssertM(iter != m_dynamicBodyMap.left.end(),
                 "Queried entity is not present in the map");
...
void PhysXPhysics::reconstructRigidBody(const G3D::Entity *entity) {
    /*auto iter = m_dynamicBodyMap.left.find(entity);
    debugAssertM(iter != m_dynamicBodyMap.left.end(),
                 "Queried entity is not present in the map");
    auto collisionObject = iter->get_right();
...
void PhysXPhysics::applyForce(G3D::Entity *entity, G3D::Point3 force) {
    /*auto iter = m_dynamicBodyMap.left.find(entity);
    debugAssertM(iter != m_dynamicBodyMap.left.end(),
                 "Queried entity is not present in the map");
    auto collisionObject = iter->get_right();
...
void PhysXPhysics::simulate(float deltaTime) {
    /*m_dynamicsWorld->stepSimulation(deltaTime);*/
}

/*btConstraintSolverPoolMt *PhysXPhysics::createSolverPool() {
